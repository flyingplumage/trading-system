...
<head>
    ...
    <title>Iris Worker v13 - {{ worker_id }}</title>
    <style>
...
<body>
    <div class="container">
        <header>
            <div>
                <h1>🚀 Iris Worker <span id="version-badge" class="badge badge-info">v13</span></h1>
    ...
    <script>
        ...
        function updateUI(s) {
            document.getElementById('version-badge').textContent = s.worker_version || 'v13';
