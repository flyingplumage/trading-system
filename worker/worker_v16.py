...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .hw-chart{height:100px;position:relative;border-left:1px solid #475569;border-bottom:1px solid #475569;margin-top:10px;overflow:visible}
...
<body>
    <div class="container">
        <header>
            <div>
                <h1>🚀 Iris Worker <span id="version-badge" class="badge badge-info">v16</span></h1>
        ...
        <div class="top-grid">
            ...
            <div class="card"><h2>💻 CPU</h2>
                ...
                <div class="hw-chart cpu"><svg class="hw-line cpu" id="cpu-svg" viewBox="0 0 300 100"></svg></div>
                <div class="hw-label">最近 60 秒</div>
            </div>
            <div class="card"><h2>🧠 内存</h2>
                <div class="hw-current" id="memory-current">0%</div>
                <div class="hw-chart memory"><svg class="hw-line memory" id="memory-svg" viewBox="0 0 300 100"></svg></div>
                <div class="hw-label">最近 60 秒</div>
            </div>
            <div class="card"><h2>💾 磁盘</h2>
                <div class="hw-current" id="disk-current">0%</div>
                <div class="hw-chart disk"><svg class="hw-line disk" id="disk-svg" viewBox="0 0 300 100"></svg></div>
    ...
    <script>
        ...
        function updateUI(s){
            document.getElementById('version-badge').textContent=s.worker_version||'v16';
