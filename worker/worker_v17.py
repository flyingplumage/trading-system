...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .hw-chart{height:100px;position:relative;border-left:1px solid #475569;border-bottom:1px solid #475569;margin-top:10px;background:rgba(0,0,0,0.1)}
        .hw-line{position:absolute;bottom:0;left:0;width:100%;height:100%}
        .hw-line polyline{fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}
...
<body>
    <div class="container">
        <header>
            <div>
                <h1>🚀 Iris Worker <span id="version-badge" class="badge badge-info">v17</span></h1>
    ...
    <script>
        ...
        function updateUI(s){
            document.getElementById('version-badge').textContent=s.worker_version||'v17';
        ...
        function renderPolylineChart(type,data){
            ...
            if(!polyline){console.log('polyline not found:',type);return;}
            ...
            console.log(type+' chart:',data.length+' points');
        }
        function renderLogs(){
