...
<head>
    ...
    <title>Iris Worker v7 - {{ worker_id }}</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .progress-fill { height: 100%; background: linear-gradient(90deg, var(--primary), #764ba2); border-radius: 5px; transition: width 0.5s ease; }
