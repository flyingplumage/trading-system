...
echo "============================================================"
echo "🚀 Iris Worker v16 一键部署"
echo "============================================================"
echo ""
echo "🎯 v16 优化："
echo "  ✅ 硬件趋势图（100px 高度）"
echo "  ✅ 日志卡片 2/3 布局"
echo "  ✅ 日志高度 600px（显示 10+ 条）"
echo "  ✅ 中文显示正常"
echo ""
...
curl -sSL "http://$SERVER_IP:8888/worker_v16.py" -o worker.py
if [ ! -s worker.py ]; then
    echo "❌ 下载失败"
    exit 1
fi
...
echo ""
echo "💡 提示："
echo "   1. 如果看到乱码，请强制刷新：Cmd+Shift+R"
echo "   2. 如果看到 HTML 源码，请清除浏览器缓存"
